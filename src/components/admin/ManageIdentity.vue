<template>
    ...
    <el-table-column prop="iiId" align = "center" label="序号" width="260" />
    <el-table-column prop="iiType" align = "center" label="类型" width="280" />
...
const search = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/identity_info/select_Identity_Info_By_Serach_Value",
        data : {
...
const handleDelete = (identity) => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/identity_info/delete_Identity_Info_By_iiId",
        data : identity,
        headers: {
...
const get = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/identity_info/select_All_Identity_Info",
        data : {
