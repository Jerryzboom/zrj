<template>
    ...
    <el-table-column prop="odId" align = "center" label="序号" width="60" />
    <el-table-column prop="miId" align = "center" label="药品号" width="80" />
    <el-table-column prop="fiId" align = "center" label="厂家号" width="80" />
    <el-table-column prop="odState" align = "center" label="是否送达" width = "200" />
    <el-table-column prop="odPayPrice" align = "center" label="总进价" width = "250" />
...
const search = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/order_detail/select_Order_Detail_By_Serach_Value",
        data : {
...
const handleDelete = (order) => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/order_detail/delete_Order_Detail_By_odId",
        data : order,
        headers: {
...
const get = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/order_detail/select_All_Order_Detail",
        data : {
