<template>
    ...
    <div style = "text-align: center;">
        <el-button type = "warning"  @click = "InsertStore">添加</el-button>
    ...
    <el-table-column prop="siId" align = "center" label="序号" width="60" />
    <el-table-column prop="miId" align = "center" label="药品名" width="80" />
    <el-table-column prop="siMiNumber" align = "center" label="库存量" width="80" />
...
const search = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/store_info/select_Store_Info_By_Serach_Value",
        data : {
...
const handleDelete = (store) => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/store_info/delete_Store_Info_By_siId",
        data : store,
        headers: {
...
const get = () => {
    axios( {
        method : "post",
        url : "http://localhost:9421/tzb/store_info/select_All_Store_Info",
        data : {
